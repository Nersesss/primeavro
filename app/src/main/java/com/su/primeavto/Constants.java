...
public class Constants {
    ...
    public static final String TOKEN = "lHs7sm6k1I";
    public static final String INTENT_KEY_AVTO = "INTENT_KEY_AVTO";
    public static final String PREFS_KEY_LANG = "PREFS_KEY_LANG";

    public static final Map<String, String> countryCodes;
    ...
    static {
        ...
        map.put("ZM", "+260");
        map.put("ZW", "+263");
        countryCodes = Collections.unmodifiableMap(map);
    }
